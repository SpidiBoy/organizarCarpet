 ...
 * CORREGIDO: Integra movimiento de DK y princesa hacia arriba
 */
public abstract class EstadoNivel {
    ...
    public static class Victoria extends EstadoNivel {
        ...
        // Velocidad de escape (igual que tu versión anterior)
        ...
        private void renderOverlayEscape(Graphics g, int centerX, int centerY) {
            switch (faseActual) {
                case FASE_CORAZON:
                    renderTexto(g, centerX, centerY, "¡Nivel Completado!", Color.YELLOW);
                    break;
                ...
                case FASE_CORAZON_ROTO:
                    renderTexto(g, centerX, centerY, "¡Ella se escapa otra vez!", new Color(255, 100, 100));
                    break;
            }
        }
        ...
        private void renderOverlayDerrotaFinal(Graphics g, int centerX, int centerY) {
            switch (faseActual) {
                case FASE_CORAZON:
                    renderTexto(g, centerX, centerY, "¡VICTORIA!", new Color(255, 215, 0));
                    break;
                ...
                case FASE_CORAZON_ROTO:
                    renderTexto(g, centerX, centerY, "¡VICTORIA TOTAL!", new Color(0, 255, 127));
                    break;
            }
        }
        ...
        private void renderTexto(Graphics g, int centerX, int centerY, String texto, Color color) {
            ...
            int w = g.getFontMetrics().stringWidth(texto);
            g.drawString(texto, centerX - w/2, centerY);
            
            // Sombra
            g.setColor(Color.BLACK);
            g.drawString(texto, centerX - w/2 + 2, centerY + 2);
        }
